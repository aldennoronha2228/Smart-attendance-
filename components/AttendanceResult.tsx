...
export function AttendanceResult({ result }: AttendanceResultProps) {
  return (
    <section className="mt-6 rounded-2xl border border-card-border bg-card p-6 shadow-sm">
      <h3 className="text-xl font-bold text-slate-900">Attendance Result</h3>
              ...
              <ul className="mt-3 space-y-2">
                {result.recognized.map((student, index) => (
                  <li
                    ...
                    className="flex items-center justify-between rounded-lg border border-sky-100 bg-white px-3 py-2 text-sm"
                  >
